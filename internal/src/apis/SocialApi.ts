...
export class SocialApi extends runtime.BaseAPI {
    ...
    async getGithubUserRaw(requestParameters: GetGithubUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetGithubUser200Response>> {
        ...
        if (requestParameters['repos'] != null) {
            queryParameters['repos'] = requestParameters['repos'];
        }

        if (requestParameters['reposLimit'] != null) {
            queryParameters['repos_limit'] = requestParameters['reposLimit'];
        }
