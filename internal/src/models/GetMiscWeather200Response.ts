...
import type { GetMiscWeather200ResponseAlertsInner } from './GetMiscWeather200ResponseAlertsInner';
import {
    GetMiscWeather200ResponseAlertsInnerFromJSON,
    GetMiscWeather200ResponseAlertsInnerFromJSONTyped,
    GetMiscWeather200ResponseAlertsInnerToJSON,
    GetMiscWeather200ResponseAlertsInnerToJSONTyped,
} from './GetMiscWeather200ResponseAlertsInner';
...
export interface GetMiscWeather200Response {
    ...
    /**
     * 官方气象预警列表（存在有效预警时返回）
     * @type {Array<GetMiscWeather200ResponseAlertsInner>}
     * @memberof GetMiscWeather200Response
     */
...
export function GetMiscWeather200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetMiscWeather200Response {
    ...
    return {
        ...
        'alerts': json['alerts'] == null ? undefined : ((json['alerts'] as Array<any>).map(GetMiscWeather200ResponseAlertsInnerFromJSON)),
...
export function GetMiscWeather200ResponseToJSONTyped(value?: GetMiscWeather200Response | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'alerts': value['alerts'] == null ? undefined : ((value['alerts'] as Array<any>).map(GetMiscWeather200ResponseAlertsInnerToJSON)),
        'aqi': value['aqi'],
