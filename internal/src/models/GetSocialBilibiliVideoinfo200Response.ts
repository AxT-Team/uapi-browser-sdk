...
export function GetSocialBilibiliVideoinfo200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetSocialBilibiliVideoinfo200Response {
    ...
    return {
        ...
        'isUpowerExclusive': json['is_upower_exclusive'] == null ? undefined : json['is_upower_exclusive'],
        'isUpowerExclusiveWithQa': json['is_upower_exclusive_with_qa'] == null ? undefined : json['is_upower_exclusive_with_qa'],
        'isUpowerPlay': json['is_upower_play'] == null ? undefined : json['is_upower_play'],
        'isUpowerPreview': json['is_upower_preview'] == null ? undefined : json['is_upower_preview'],
        ...
        'payType': json['pay_type'] == null ? undefined : json['pay_type'],
...
export function GetSocialBilibiliVideoinfo200ResponseToJSONTyped(value?: GetSocialBilibiliVideoinfo200Response | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'is_upower_exclusive': value['isUpowerExclusive'],
        'is_upower_exclusive_with_qa': value['isUpowerExclusiveWithQa'],
        'is_upower_play': value['isUpowerPlay'],
        'is_upower_preview': value['isUpowerPreview'],
