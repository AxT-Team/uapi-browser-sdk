...
```typescript
import type { GetClipzyGet200Response } from 'uapi-browser-sdk-browser'
...
} satisfies GetClipzyGet200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetClipzyGet200Response
