...
async function example() {
  ...
  const body = {
    // 'bilibili' | 'acfun' | 'weibo' | 'zhihu' | 'zhihu-daily' | 'douyin' | 'kuaishou' | 'douban-movie' | 'douban-group' | 'tieba' | 'hupu' | 'miyoushe' | 'ngabbs' | 'v2ex' | '52pojie' | 'hostloc' | 'coolapk' | 'baidu' | 'thepaper' | 'toutiao' | 'qq-news' | 'sina' | 'sina-news' | 'netease-news' | 'huxiu' | 'ifanr' | 'sspai' | 'ithome' | 'ithome-xijiayi' | 'juejin' | 'jianshu' | 'guokr' | '36kr' | '51cto' | 'csdn' | 'nodeseek' | 'hellogithub' | 'lol' | 'genshin' | 'honkai' | 'starrail' | 'weread' | 'weatheralarm' | 'earthquake' | 'history' | 你想要查询的热榜平台。支持多种主流平台类型，详见下方[可选值](#可选值)表格。
    type: weibo,
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **type** | `bilibili`, `acfun`, `weibo`, `zhihu`, `zhihu-daily`, `douyin`, `kuaishou`, `douban-movie`, `douban-group`, `tieba`, `hupu`, `miyoushe`, `ngabbs`, `v2ex`, `52pojie`, `hostloc`, `coolapk`, `baidu`, `thepaper`, `toutiao`, `qq-news`, `sina`, `sina-news`, `netease-news`, `huxiu`, `ifanr`, `sspai`, `ithome`, `ithome-xijiayi`, `juejin`, `jianshu`, `guokr`, `36kr`, `51cto`, `csdn`, `nodeseek`, `hellogithub`, `lol`, `genshin`, `honkai`, `starrail`, `weread`, `weatheralarm`, `earthquake`, `history` | 你想要查询的热榜平台。支持多种主流平台类型，详见下方[可选值](#可选值)表格。 | [Defaults to `undefined`] [Enum: bilibili, acfun, weibo, zhihu, zhihu-daily, douyin, kuaishou, douban-movie, douban-group, tieba, hupu, miyoushe, ngabbs, v2ex, 52pojie, hostloc, coolapk, baidu, thepaper, toutiao, qq-news, sina, sina-news, netease-news, huxiu, ifanr, sspai, ithome, ithome-xijiayi, juejin, jianshu, guokr, 36kr, 51cto, csdn, nodeseek, hellogithub, lol, genshin, honkai, starrail, weread, weatheralarm, earthquake, history] |
...
async function example() {
  ...
  const body = {
    // string | 标准的城市名称，如 \'北京\', \'上海市\', \'福田区\'。请使用官方的省、市、区县行政区划名称。 (optional)
    city: 北京,
    // string | 高德地图的6位数字城市编码。例如，北京市的Adcode是 \'110000\'。使用Adcode查询更准确、更快速。 (optional)
    adcode: 110000,
