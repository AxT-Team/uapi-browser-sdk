...
| [**postTextMarkdownToHtml**](TextApi.md#posttextmarkdowntohtmloperation) | **POST** /text/markdown-to-html | Markdown 转 HTML |
| [**postTextMarkdownToPdf**](TextApi.md#posttextmarkdowntopdfoperation) | **POST** /text/markdown-to-pdf | Markdown 转 PDF |
...
import type { PostTextMarkdownToHtmlOperationRequest } from 'uapi-browser-sdk-browser';
...
async function example() {
  ...
  } satisfies PostTextMarkdownToHtmlOperationRequest;

  try {
    const data = await api.postTextMarkdownToHtml(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> Blob postTextMarkdownToPdf(postTextMarkdownToPdfRequest)
...
import type { PostTextMarkdownToPdfOperationRequest } from 'uapi-browser-sdk-browser';
...
async function example() {
  ...
  } satisfies PostTextMarkdownToPdfOperationRequest;

  try {
    const data = await api.postTextMarkdownToPdf(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
