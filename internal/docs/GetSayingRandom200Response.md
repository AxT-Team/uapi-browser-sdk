...
```typescript
import type { GetSayingRandom200Response } from 'uapi-browser-sdk-browser'
...
const example = {
  ...
  "seed": daily20260625-,
  "timeSegment": noon,
} satisfies GetSayingRandom200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetSayingRandom200Response
