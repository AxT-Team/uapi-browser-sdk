...
```typescript
import type { PostTextMarkdownToPdfRequest } from 'uapi-browser-sdk-browser'
...
```,
  "theme": github,
  "paperSize": A4,
} satisfies PostTextMarkdownToPdfRequest
...
const exampleParsed = JSON.parse(exampleJSON) as PostTextMarkdownToPdfRequest
